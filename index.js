...
. No se asignará MENSAJEENVIAR_FIELD_ID, lo que probablemente causará un error al intentar actualizar el lead.`);
    ...
    if (cargaPendiente) {
      ...
      try {
        ...
        if (MENSAJEENVIAR_FIELD_ID) {
          const mensajesDeAcreditacionYPromocion = [
            "Todo listo, ya podés iniciar ♥. Recordá que en nuestra página tenés chat directo con nosotros las 24 hs, todos los días del año. Si algún número no responde, escribinos por ahí: https://ganamosnet.win",
            ...
            "Ya quedó listo ♥. Si alguna línea demora en responder, podés contactarnos desde el chat disponible en nuestra web: https://ganamosnet.win",
            ...
            "Todo correcto ♥. Ya podés continuar. Ante cualquier inconveniente, nuestro chat web está activo las 24 hs: https://ganamosnet.win",
            ...
            "Todo listo por acá ♥. Si necesitás ayuda, el chat de nuestra web está disponible en cualquier momento: https://ganamosnet.win",
            ...
            "Ya quedó resuelto ♥. Si no lográs comunicarte por WhatsApp, encontranos en el chat web: https://ganamosnet.win",
            ...
            "Perfecto, ya podés avanzar ♥. Recordá que siempre estamos disponibles desde la web: https://ganamosnet.win",
            ...
            "Todo realizado ♥. Si una línea no recibe mensajes, podés comunicarte con nosotros desde la web: https://ganamosnet.win",
            ...
            "Perfecto, ya podés iniciar ♥. Si necesitás ayuda, estamos disponibles las 24 hs mediante la página: https://ganamosnet.win",
...
. No se asignará MENSAJEENVIAR_FIELD_ID, lo que probablemente causará un error al intentar actualizar el lead.`);
    ...
    if (cargaPendiente) {
      ...
      try {
        ...
        if (MENSAJEENVIAR_FIELD_ID) {
          const mensajesDeAcreditacionYPromocion = [
            "Todo listo, ya podés iniciar ♥. Recordá que en nuestra página tenés chat directo con nosotros las 24 hs, todos los días del año. Si algún número no responde, escribinos por ahí: https://ganamosnet.link",
            ...
            "Ya quedó listo ♥. Si alguna línea demora en responder, podés contactarnos desde el chat disponible en nuestra web: https://ganamosnet.link",
            ...
            "Todo correcto ♥. Ya podés continuar. Ante cualquier inconveniente, nuestro chat web está activo las 24 hs: https://ganamosnet.link",
            ...
            "Todo listo por acá ♥. Si necesitás ayuda, el chat de nuestra web está disponible en cualquier momento: https://ganamosnet.link",
            ...
            "Ya quedó resuelto ♥. Si no lográs comunicarte por WhatsApp, encontranos en el chat web: https://ganamosnet.link",
            ...
            "Perfecto, ya podés avanzar ♥. Recordá que siempre estamos disponibles desde la web: https://ganamosnet.link",
            ...
            "Todo realizado ♥. Si una línea no recibe mensajes, podés comunicarte con nosotros desde la web: https://ganamosnet.link",
            ...
            "Perfecto, ya podés iniciar ♥. Si necesitás ayuda, estamos disponibles las 24 hs mediante la página: https://ganamosnet.link",
